...
public class ConfirmerInscriptionsServlet extends HttpServlet {
   ...
   */
  public ConfirmerInscriptionsServlet() {
    super();
    this.genson =
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      verifierOuvrierValide(req, resp);
   ...
   */
  private void verifierOuvrierValide(HttpServletRequest req, HttpServletResponse resp)
      throws IOException {
